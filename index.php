...
<body class="bg-light">
        ...
        <form>
          ...
          <div class="modal-body">
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="form-control shadow-none">
            </div>
            <div class="mb-4">
              <label class="form-label">Password</label>
              <input type="password" class="form-control" id="form-control shadow-none">
            </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <form>
          ...
          <div class="modal-body">
            <span class="badge bg-light text-dark text-dark mb-3 text-wrap lh-base">
              Note: Your details must match your ID (NID Card, passport, driving license etc.)
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-md-12 p-0 mb-3">
                  ...
                  <textarea class="form-control shadow-none shadow-none" rows="1"></textarea>
                </div>
                <div class="col-md-6 ps-0 mb-3">
  ...
  <div class="container-fluid bg-white mt-5">
    <div class="row">
      <div class="col-lg-4 p-4">
        ...
        <p>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit.
          Harum, amet libero? Et fuga vero voluptatum repellendus perferendis,
          nihil explicabo exercitationem.
        </p>
      </div>
      <div class="col-lg-4 p-4">
  ...
  <h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developed by Faham</h6>
